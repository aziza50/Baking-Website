...
export default function AboutUs() {
  return (
    <div className="relative my-30 max-w-xl sm:max-w-4xl md:max-w-6xl lg:max-w-7xl rounded-xl overflow-hidden px-4 mx-auto">
      <motion.div
      ...
      >
        <h2
          className={`absolute top-10 md:top-15 text-center left-0 w-full text-white text-7xl z-20 sm:text-7xl md:text-8xl lg:text-9xl px-4 ${dawn.className}`}
        >
          About Us
        </h2>

        <h3
          className={`absolute top-40 sm:top-50 sm:text-3xl md:top-60 md:text-4xl lg:top-70 lg:text-4xl w-full text-center text-white z-20 px-10 ${josefin.className}`}
        >
      ...
      <Image
        ...
        className="w-full h-[30rem] sm:h-[30rem] md:h-[40rem] lg:h-[40rem] object-cover rounded-xl"
